(function () {
	...
	function create_else_block(ctx) {
		...
		return {
			c() {
				div = element("div");
				div.innerHTML = `<img alt="Viznaga (logotipo)" src="viznaga_logo.png">
